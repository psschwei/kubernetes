...
var map_Probe = map[string]string{
	...
	"initialDelaySeconds":           "Number of seconds after the container has started before liveness probes are initiated. Defaults to 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes",
	...
	"periodSeconds":                 "How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1. If PeriodMilliseconds is set, this field is ignored.",
	...
	"periodMilliseconds":            "How often (in milliseconds) to perform the probe, defaults to 0. If this field is set, the PeriodSeconds field is ignored.",
}
